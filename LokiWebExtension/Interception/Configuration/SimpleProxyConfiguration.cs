...
using LokiWebExtension.Interception.Internal.Configuration;
using LokiWebExtension.Interception.Internal.Interfaces;
using LokiWebExtension.Interception.Strategies;

namespace SimLokiWebExtension.InterceptionpleProxy.Configuration
{
    using System;
